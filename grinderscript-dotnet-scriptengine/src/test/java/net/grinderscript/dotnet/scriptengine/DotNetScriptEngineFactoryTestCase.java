...
public class DotNetScriptEngineFactoryTestCase {
	...
	public void before() throws Exception {
		...
		factory = new DotNetScriptEngineFactory.Default();
	}

	@Test
	public void createScriptEngineShouldPassOnProperties() {
		DotNetScriptEngine scriptEngine = factory.createScriptEngine(properties, script);
