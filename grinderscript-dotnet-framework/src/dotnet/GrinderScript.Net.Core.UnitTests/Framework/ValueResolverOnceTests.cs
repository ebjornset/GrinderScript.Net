...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueResolverOnceTests.cs" company="http://GrinderScript.net">
//
...
namespace GrinderScript.Net.Core.UnitTests.Framework
{
    ...
    [TestFixture]
    public class ValueResolverOnceTests
    {
        ...
        {
            Assert.Throws(Is.InstanceOf<ArgumentNullException>().With.Message.Contains("resolveFunc"), () => new ValueResolverOnce<bool>(null));
        }
        ...
        public void CtorShouldResolveValue()
        {
            ...
            new ValueResolverOnce<bool>(() => loggerMock.Object.IsDebugEnabled);
            // ReSharper restore ObjectCreationAsStatement
            loggerMock.Verify(l => l.IsDebugEnabled);
        }
        ...
        public void GetValueShouldReuseResolvedValue()
        {
            ...
            var resolver = new ValueResolverOnce<bool>(() => loggerMock.Object.IsInfoEnabled);
            Assert.That(resolver.Value, Is.True);
            loggerMock.Verify(l => l.IsInfoEnabled, Times.AtMostOnce());
        }
    }
}