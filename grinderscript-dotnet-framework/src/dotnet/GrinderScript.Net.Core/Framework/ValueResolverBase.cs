...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueResolverBase.cs" company="http://GrinderScript.net">
//
...
{
    public abstract class ValueResolverBase<T> : IValueResolver<T>
    {
        protected ValueResolverBase(Func<T> resolveFunc)
        {
            if (resolveFunc == null)
            {
