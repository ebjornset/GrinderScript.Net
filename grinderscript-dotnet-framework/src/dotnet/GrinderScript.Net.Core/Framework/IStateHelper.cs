...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IStateHelper.cs" company="http://GrinderScript.net">
//
...
namespace GrinderScript.Net.Core.Framework
{
    ...
    {
        bool IsInState { get; }
        bool IsNotInState { get; }

        void CheckIsInState();
        void CheckIsNotInState();

        void SafeTransformToState(Action transformToState);
    }
}
